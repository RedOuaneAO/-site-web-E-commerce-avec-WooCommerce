    ...
    <div class="wrap">
        ...
        <form method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">
            ...
            <div>
                ...
                <input type="text" name="name" class="form-control rounded" pattern="^[a-zA-Z\s]+$" required />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="subject" class="form-control rounded" pattern="^[a-zA-Z0-9\s]+$" required />
            </div>
            <div>
                <label for="message">Message:</label>
                <textarea name="message" class="form-control" required></textarea>
            </div>
            <input type="submit" class="mt-3 rounded" value="Send" />
        </form>
    </div>
    <?php
}
